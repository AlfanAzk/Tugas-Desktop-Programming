...
public class TugasGUI extends javax.swing.JFrame {
    ...
    private void Tombol2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Tombol2ActionPerformed
        ...
        switch(jawab)
        {
            case JOptionPane.YES_OPTION: 
                JOptionPane.showMessageDialog(this, "Kamu memilih Yes");
                break;
            case JOptionPane.NO_OPTION:
                JOptionPane.showMessageDialog(this, "Kamu memilih No");
                break;
            case JOptionPane.CANCEL_OPTION:
                JOptionPane.showMessageDialog(this, "Kamu memilih Cancel");
        }
    ...
    private void Tombol3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Tombol3ActionPerformed
        // TODO add your handling code here:
        int number = Integer.parseInt(JOptionPane.showInputDialog("Silahkan Masukan Angka"));  

        if(number%2==0)
            JOptionPane.showMessageDialog(null,"Maaf bilangan yang Anda masukkan bukan bilangan ganjil.\nHarap masukkan bilangan ganjil !");
        else
            JOptionPane.showMessageDialog(null,"Bilangan " + number + " adalah bilangan ganjil");
